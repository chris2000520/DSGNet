class BaseConfig:
    def __init__(self,):
        ...
        # Edge Head (For CGFNET)
        self.use_edge_head = False
        ...
        # self.class_weights = [0.3182, 0.2082, 5.0924, 0.1744, 0.7103, 0.4175, 4.5371, 1.8386, 1.0000, 6.6059, 6.6066]
        self.ohem_thrs = 0.7
        ...
        self.weight_decay = 5e-4    # For SGD
