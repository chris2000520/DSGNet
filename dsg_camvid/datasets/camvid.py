...
class CamVid(Dataset):
    ...
    def __init__(self, config, mode='train'):
        ...
        dir = mode + 'annot'
        # dir = mode + '_label'
        img_dir = os.path.join(data_root, mode)
        ...
        if mode == 'train':
            self.transform = AT.Compose([
                ...
                # AT.Rotate(limit=90, interpolation=1, border_mode=4, value=None, mask_value=None, always_apply=False, p=0.8),
                ...
                # AT.Transpose(p=0.5),
                # AT.CLAHE(p=0.5),
                # AT.RandomGamma(p=0.5),
                # AT.ChannelShuffle(p=0.5),
